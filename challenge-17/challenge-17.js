...
*/
// ?
Texto = "Manuel Marques de Sousa, Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 – Rio de Janeiro, 18 de julho de 1875), apelidado de O Centauro de Luvas, foi um militar, político, abolicionista e monarquista brasileiro."
...
// ?        
console.log(Texto.replace(/Manuel Marques de Sousa/i,'Thiago Miranda'))
...
// ?
console.log(Texto.replace(/brasileiro/g,'fortalezense'))
/*
...
// ?
console.log(Texto.replace(/[0-9]/g,'-'))
...
newDate = function (regex , dia ,mes , ano ){
...
console.log(Texto.replace(regexDate,newDate))
